...
[source,java]
include::https://github.com/jimbasler-pivotal/webflux-workshop/blob/master/stock-quotes/src/main/java/io/spring/workshop/stockquotes/StockQuotesApplication.java[]
